...
bool myAgeCompartor(customer c1, customer c2){
    if(c1.age < c2.age ){
        // we don't need a swap : beause we are sorting vector<customer> in the increasing order of their ages
        return true;
    }else{
        // we need swap
        return false;
...
int main(){
    ...
    v.push_back(customer("krishna",18,'M',200));

...
int main() {
	...
	set<int> s;    // multiset<int> s = for counting extra coming no. in set here 1 is coming etra so it will show size 6.
	...
	cout << "size : " << s.size() << endl;  // there are 2 '1' so size show only 5 excluding size of 1 insertion. 
	...
	if(s.find(3) != s.end()) {      // for find specific value in set.
